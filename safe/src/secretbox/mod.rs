...
pub extern "C" fn crypto_secretbox(
    ...
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox(c, m, mlen, n, k) })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_boxzerobytes() -> usize {
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_boxzerobytes() })
}
...
pub extern "C" fn crypto_secretbox_easy(
    ...
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_easy(c, m, mlen, n, k) })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_keybytes() -> usize {
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_keybytes() })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_keygen(k: *mut ::std::os::raw::c_uchar) {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_keygen(k);
    })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_macbytes() -> usize {
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_macbytes() })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_messagebytes_max() -> usize {
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_messagebytes_max() })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_noncebytes() -> usize {
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_noncebytes() })
}
...
pub extern "C" fn crypto_secretbox_open(
    ...
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_open(m, c, clen, n, k) })
}
...
pub extern "C" fn crypto_secretbox_open_easy(
    ...
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_open_easy(m, c, clen, n, k)
    })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_primitive() -> *const ::std::os::raw::c_char {
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_primitive() })
}
...
pub extern "C" fn crypto_secretbox_xsalsa20poly1305_boxzerobytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xsalsa20poly1305_boxzerobytes()
    })
}
...
pub extern "C" fn crypto_secretbox_xsalsa20poly1305_keybytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xsalsa20poly1305_keybytes()
    })
}
...
pub extern "C" fn crypto_secretbox_xsalsa20poly1305_keygen(k: *mut ::std::os::raw::c_uchar) {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xsalsa20poly1305_keygen(k);
    })
}
...
pub extern "C" fn crypto_secretbox_xsalsa20poly1305_macbytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xsalsa20poly1305_macbytes()
    })
}
...
pub extern "C" fn crypto_secretbox_xsalsa20poly1305_noncebytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xsalsa20poly1305_noncebytes()
    })
}
...
pub extern "C" fn crypto_secretbox_xsalsa20poly1305_zerobytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xsalsa20poly1305_zerobytes()
    })
}

#[no_mangle]
pub extern "C" fn crypto_secretbox_zerobytes() -> usize {
    abort_on_panic(|| unsafe { crate::symmetric_impl::crypto_secretbox_zerobytes() })
}
...
pub extern "C" fn crypto_secretbox_xchacha20poly1305_easy(
    ...
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xchacha20poly1305_easy(c, m, mlen, n, k)
    })
}
...
pub extern "C" fn crypto_secretbox_xchacha20poly1305_keybytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xchacha20poly1305_keybytes()
    })
}
...
pub extern "C" fn crypto_secretbox_xchacha20poly1305_macbytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xchacha20poly1305_macbytes()
    })
}
...
pub extern "C" fn crypto_secretbox_xchacha20poly1305_noncebytes() -> usize {
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xchacha20poly1305_noncebytes()
    })
}
...
pub extern "C" fn crypto_secretbox_xchacha20poly1305_open_detached(
    ...
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xchacha20poly1305_open_detached(
            m, c, mac, clen, n, k,
        )
    })
}
...
pub extern "C" fn crypto_secretbox_xchacha20poly1305_open_easy(
    ...
    abort_on_panic(|| unsafe {
        crate::symmetric_impl::crypto_secretbox_xchacha20poly1305_open_easy(m, c, clen, n, k)
    })
}
