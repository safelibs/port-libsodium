...
pub extern "C" fn crypto_stream_salsa2012(
    ...
    abort_on_panic(|| unsafe { crate::upstream::load().crypto_stream_salsa2012(c, clen, n, k) })
}

#[no_mangle]
pub extern "C" fn crypto_stream_salsa2012_keybytes() -> usize {
    abort_on_panic(|| unsafe { crate::upstream::load().crypto_stream_salsa2012_keybytes() })
}

#[no_mangle]
pub extern "C" fn crypto_stream_salsa2012_keygen(k: *mut ::std::os::raw::c_uchar) {
    abort_on_panic(|| unsafe {
        crate::upstream::load().crypto_stream_salsa2012_keygen(k);
    })
}

#[no_mangle]
pub extern "C" fn crypto_stream_salsa2012_messagebytes_max() -> usize {
    abort_on_panic(|| unsafe { crate::upstream::load().crypto_stream_salsa2012_messagebytes_max() })
}

#[no_mangle]
pub extern "C" fn crypto_stream_salsa2012_noncebytes() -> usize {
    abort_on_panic(|| unsafe { crate::upstream::load().crypto_stream_salsa2012_noncebytes() })
}
...
pub extern "C" fn crypto_stream_salsa2012_xor(
    ...
    abort_on_panic(|| unsafe {
        crate::upstream::load().crypto_stream_salsa2012_xor(c, m, mlen, n, k)
    })
}
